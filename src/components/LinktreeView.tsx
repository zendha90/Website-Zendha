...
const VerifiedBadge = () => (
  <svg viewBox="0 0 24 24" className="w-[18px] h-[18px] text-[#0095f6] fill-current shrink-0" aria-label="Verified">
    <path d="M12.003 21.25a.747.747 0 0 1-.363-.095l-3.136-1.81a.755.755 0 0 0-.616-.068l-3.415.914a.75 75 0 0 1-.892-.515L2.668 16.27a.754.754 0 0 0-.414-.473L.577 14.3a.75.75 0 0 1-.338-.975l1.62-3.24a.742.742 0 0 0 0-.67L.24 6.175a.75.75 0 0 1 .338-.975l1.677-1.5a.755.755 0 0 0 .414-.473l.913-3.415a.75.75 0 0 1 .892-.515l3.415.914c.216.058.441.033.616-.068l3.136-1.81a.755.755 0 0 1 .726 0l3.136 1.81c.175.101.4.126.616.068l3.415-.914a.75.75 0 0 1 .892.515l.913 3.415c.058.216.2.392.414.473l1.677 1.5a.75.75 0 0 1 .338.975l-1.62 3.24a.742.742 0 0 0 0 .67l1.62 3.24a.75.75 0 0 1-.338.975l-1.677 1.5a.754.754 0 0 0-.414.473l-.913 3.415a.75.75 0 0 1-.892.515l-3.415-.914a.755.755 0 0 0-.616.068l-3.136 1.81a.747.747 0 0 1-.363.095Z" />
    <path d="M10.741 15.11a.75.75 0 0 1-.53-.22l-2.45-2.45a.75.75 0 0 1 1.06-1.06l1.92 1.92 4.14-4.14a.75.75 0 1 1 1.06 1.06l-4.67 4.67a.75.75 0 0 1-.53.22Z" fill="white" />
  </svg>
);
